						...
						<div class="wrap">
							<div id="memberId_tr" class="wrap_input_info05 d_input_write"
								...
								<div class="wrap_input">
									<input type="text" id="id" name="id" title="아이디 입력 편집창"
										placeholder="6~30자로 입력" class="text53" style="width: 276px;">
									<input type="text" id="img" name="img" title="아이디 입력 편집창"
										placeholder="img문자로 임시 대체" class="text53"
										style="width: 276px;">
								</div>
				...
				<tr>
					...
					<td>
						<div class="wrap">
							...
							<p id="memberPwd1_usemsg" class="txt_input_info">8자 ~ 20자,
								영문, 숫자, 특수문자 사용</p>
					...
					<td>
						<div class="wrap">
							<div id="memberNick_tr" class="wrap_input_info04 d_input_write"
								style="width: 331px;">
								<div class="wrap_input">
									<input type="text" id="img" name="name" title="닉네임 입력 편집창"
										placeholder="한글, 영문 2~15자" class="text53"
										style="width: 276px;">
								</div>
								<div class="wrap_input_check">
									<a href="#" class="btn_input_check d_input_del"
